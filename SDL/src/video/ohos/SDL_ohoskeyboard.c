...
static const struct {
    ...
    { KEYCODE_MEDIA_NEXT, SDL_SCANCODE_MEDIA_NEXT_TRACK },
    { KEYCODE_MEDIA_PREVIOUS, SDL_SCANCODE_MEDIA_PREVIOUS_TRACK },
    { KEYCODE_MEDIA_STOP, SDL_SCANCODE_MEDIA_STOP },
    { KEYCODE_MEDIA_PLAY_PAUSE, SDL_SCANCODE_MEDIA_PLAY },
    { KEYCODE_VOLUME_MUTE, SDL_SCANCODE_MUTE },
    { KEYCODE_EXPLORER, SDL_SCANCODE_UNKNOWN }, /* SDL2 SDL_SCANCODE_WWW was removed in SDL3 */
    { KEYCODE_ENVELOPE, SDL_SCANCODE_UNKNOWN }, /* SDL2 SDL_SCANCODE_MAIL was removed in SDL3 */
    { KEYCODE_CALC, SDL_SCANCODE_UNKNOWN },     /* SDL2 SDL_SCANCODE_CALCULATOR was removed in SDL3 */
    { KEYCODE_COMPUTER, SDL_SCANCODE_UNKNOWN }, /* SDL2 SDL_SCANCODE_COMPUTER was removed in SDL3 */
    ...
    { KEYCODE_BRIGHTNESS_DOWN, SDL_SCANCODE_UNKNOWN }, /* removed in SDL3 */
    { KEYCODE_BRIGHTNESS_UP, SDL_SCANCODE_UNKNOWN },   /* removed in SDL3 */
    { KEYCODE_KBDILLUM_TOGGLE, SDL_SCANCODE_UNKNOWN }, /* removed in SDL3 */
    { KEYCODE_KBDILLUM_DOWN, SDL_SCANCODE_UNKNOWN },   /* removed in SDL3 */
    { KEYCODE_KBDILLUM_UP, SDL_SCANCODE_UNKNOWN },     /* removed in SDL3 */
...
{
    /* SDL3 manages a default keymap internally; provide one explicitly so
     * the default scancode->key mapping is available. */
...
{
    return SDL_SendKeyboardKey(0, 0, keycode, TranslateKeycode(keycode), true);
}

int OHOS_OnKeyUp(int keycode)
{
    return SDL_SendKeyboardKey(0, 0, keycode, TranslateKeycode(keycode), false);
}

bool OHOS_HasScreenKeyboardSupport(SDL_VideoDevice *_this)
{
    return true;
}

bool OHOS_IsScreenKeyboardShown(SDL_VideoDevice *_this, SDL_Window* window)
{
    return true;
}
...
{
    OHOS_NAPI_ShowTextInputKeyboard(true);
}
