...
int OHOS_Vulkan_LoadLibrary(SDL_VideoDevice *_this, const char *path)
{
    ...
    bool hasXComponentExtension = false;
    bool hasOHOSXComponentExtension = false;
...
bool OHOS_Vulkan_CreateXComponent(SDL_VideoDevice *_this, SDL_Window *window, VkInstance instance,
