...
/////////////////////////three.cj hand written functions (safe accessors & font capabilities)
// NOTE: added by the three.cj project to fill gaps of the cimgui generator output.
// These wrappers expose ImGui struct fields via C functions so the Cangjie FFI layer
// never needs to hard-code struct offsets. Field types are widened to C primitive
// types (int / float / unsigned int) to keep the FFI ABI unambiguous.

// ---- ImFontConfig accessors ----
CIMGUI_API void ImFontConfig_Set_MergeMode(ImFontConfig* self, int merge_mode) { self->MergeMode = (merge_mode != 0); }
CIMGUI_API int ImFontConfig_Get_MergeMode(ImFontConfig* self) { return self->MergeMode ? 1 : 0; }
CIMGUI_API void ImFontConfig_Set_PixelSnapH(ImFontConfig* self, int pixel_snap_h) { self->PixelSnapH = (pixel_snap_h != 0); }
CIMGUI_API int ImFontConfig_Get_PixelSnapH(ImFontConfig* self) { return self->PixelSnapH ? 1 : 0; }
CIMGUI_API void ImFontConfig_Set_OversampleH(ImFontConfig* self, int oversample_h) { self->OversampleH = (ImS8)oversample_h; }
CIMGUI_API int ImFontConfig_Get_OversampleH(ImFontConfig* self) { return self->OversampleH; }
CIMGUI_API void ImFontConfig_Set_OversampleV(ImFontConfig* self, int oversample_v) { self->OversampleV = (ImS8)oversample_v; }
CIMGUI_API int ImFontConfig_Get_OversampleV(ImFontConfig* self) { return self->OversampleV; }
CIMGUI_API void ImFontConfig_Set_EllipsisChar(ImFontConfig* self, unsigned int ellipsis_char) { self->EllipsisChar = (ImWchar)ellipsis_char; }
CIMGUI_API unsigned int ImFontConfig_Get_EllipsisChar(ImFontConfig* self) { return self->EllipsisChar; }
CIMGUI_API void ImFontConfig_Set_SizePixels(ImFontConfig* self, float size_pixels) { self->SizePixels = size_pixels; }
CIMGUI_API float ImFontConfig_Get_SizePixels(ImFontConfig* self) { return self->SizePixels; }
CIMGUI_API void ImFontConfig_Set_GlyphRanges(ImFontConfig* self, const unsigned short* glyph_ranges) { self->GlyphRanges = (const ImWchar*)glyph_ranges; }
CIMGUI_API const unsigned short* ImFontConfig_Get_GlyphRanges(ImFontConfig* self) { return (const unsigned short*)self->GlyphRanges; }
CIMGUI_API void ImFontConfig_Set_GlyphOffset(ImFontConfig* self, const ImVec2_c glyph_offset) { self->GlyphOffset = ConvertToCPP_ImVec2(glyph_offset); }
CIMGUI_API ImVec2_c ImFontConfig_Get_GlyphOffset(ImFontConfig* self) { return ConvertFromCPP_ImVec2(self->GlyphOffset); }
CIMGUI_API void ImFontConfig_Set_GlyphMinAdvanceX(ImFontConfig* self, float glyph_min_advance_x) { self->GlyphMinAdvanceX = glyph_min_advance_x; }
CIMGUI_API float ImFontConfig_Get_GlyphMinAdvanceX(ImFontConfig* self) { return self->GlyphMinAdvanceX; }
CIMGUI_API void ImFontConfig_Set_GlyphMaxAdvanceX(ImFontConfig* self, float glyph_max_advance_x) { self->GlyphMaxAdvanceX = glyph_max_advance_x; }
CIMGUI_API float ImFontConfig_Get_GlyphMaxAdvanceX(ImFontConfig* self) { return self->GlyphMaxAdvanceX; }
CIMGUI_API void ImFontConfig_Set_GlyphExtraAdvanceX(ImFontConfig* self, float glyph_extra_advance_x) { self->GlyphExtraAdvanceX = glyph_extra_advance_x; }
CIMGUI_API float ImFontConfig_Get_GlyphExtraAdvanceX(ImFontConfig* self) { return self->GlyphExtraAdvanceX; }
CIMGUI_API void ImFontConfig_Set_FontNo(ImFontConfig* self, unsigned int font_no) { self->FontNo = font_no; }
CIMGUI_API unsigned int ImFontConfig_Get_FontNo(ImFontConfig* self) { return self->FontNo; }
CIMGUI_API void ImFontConfig_Set_RasterizerMultiply(ImFontConfig* self, float rasterizer_multiply) { self->RasterizerMultiply = rasterizer_multiply; }
CIMGUI_API float ImFontConfig_Get_RasterizerMultiply(ImFontConfig* self) { return self->RasterizerMultiply; }
CIMGUI_API void ImFontConfig_Set_RasterizerDensity(ImFontConfig* self, float rasterizer_density) { self->RasterizerDensity = rasterizer_density; }
CIMGUI_API float ImFontConfig_Get_RasterizerDensity(ImFontConfig* self) { return self->RasterizerDensity; }
CIMGUI_API void ImFontConfig_Set_ExtraSizeScale(ImFontConfig* self, float extra_size_scale) { self->ExtraSizeScale = extra_size_scale; }
CIMGUI_API float ImFontConfig_Get_ExtraSizeScale(ImFontConfig* self) { return self->ExtraSizeScale; }
CIMGUI_API void ImFontConfig_Set_FontData(ImFontConfig* self, void* font_data) { self->FontData = font_data; }
CIMGUI_API void* ImFontConfig_Get_FontData(ImFontConfig* self) { return self->FontData; }
CIMGUI_API void ImFontConfig_Set_FontDataSize(ImFontConfig* self, int font_data_size) { self->FontDataSize = font_data_size; }
CIMGUI_API int ImFontConfig_Get_FontDataSize(ImFontConfig* self) { return self->FontDataSize; }
CIMGUI_API void ImFontConfig_Set_FontDataOwnedByAtlas(ImFontConfig* self, int font_data_owned_by_atlas) { self->FontDataOwnedByAtlas = (font_data_owned_by_atlas != 0); }
CIMGUI_API int ImFontConfig_Get_FontDataOwnedByAtlas(ImFontConfig* self) { return self->FontDataOwnedByAtlas ? 1 : 0; }

// ---- ImGuiIO accessors ----
CIMGUI_API ImFontAtlas* ImGuiIO_Get_Fonts(ImGuiIO* self) { return self->Fonts; }
CIMGUI_API void ImGuiIO_Set_Fonts(ImGuiIO* self, ImFontAtlas* fonts) { self->Fonts = fonts; }
CIMGUI_API ImFont* ImGuiIO_Get_FontDefault(ImGuiIO* self) { return self->FontDefault; }
CIMGUI_API void ImGuiIO_Set_FontDefault(ImGuiIO* self, ImFont* font_default) { self->FontDefault = font_default; }
CIMGUI_API ImVec2_c ImGuiIO_Get_DisplaySize(ImGuiIO* self) { return ConvertFromCPP_ImVec2(self->DisplaySize); }
CIMGUI_API void ImGuiIO_Set_DisplaySize(ImGuiIO* self, ImVec2_c display_size) { self->DisplaySize = ConvertToCPP_ImVec2(display_size); }
CIMGUI_API ImVec2_c ImGuiIO_Get_DisplayFramebufferScale(ImGuiIO* self) { return ConvertFromCPP_ImVec2(self->DisplayFramebufferScale); }
CIMGUI_API void ImGuiIO_Set_DisplayFramebufferScale(ImGuiIO* self, ImVec2_c display_framebuffer_scale) { self->DisplayFramebufferScale = ConvertToCPP_ImVec2(display_framebuffer_scale); }
CIMGUI_API float ImGuiIO_Get_DeltaTime(ImGuiIO* self) { return self->DeltaTime; }
CIMGUI_API void ImGuiIO_Set_DeltaTime(ImGuiIO* self, float delta_time) { self->DeltaTime = delta_time; }
CIMGUI_API int ImGuiIO_Get_ConfigFlags(ImGuiIO* self) { return (int)self->ConfigFlags; }
CIMGUI_API void ImGuiIO_Set_ConfigFlags(ImGuiIO* self, int config_flags) { self->ConfigFlags = (ImGuiConfigFlags)config_flags; }
CIMGUI_API int ImGuiIO_Get_BackendFlags(ImGuiIO* self) { return (int)self->BackendFlags; }
CIMGUI_API void ImGuiIO_Set_BackendFlags(ImGuiIO* self, int backend_flags) { self->BackendFlags = (ImGuiBackendFlags)backend_flags; }

// ---- ImGuiStyle accessors ----
CIMGUI_API float ImGuiStyle_Get_FontScaleMain(ImGuiStyle* self) { return self->FontScaleMain; }
CIMGUI_API void ImGuiStyle_Set_FontScaleMain(ImGuiStyle* self, float font_scale_main) { self->FontScaleMain = font_scale_main; }
CIMGUI_API float ImGuiStyle_Get_FontSizeBase(ImGuiStyle* self) { return self->FontSizeBase; }
CIMGUI_API void ImGuiStyle_Set_FontSizeBase(ImGuiStyle* self, float font_size_base) { self->FontSizeBase = font_size_base; }

// ---- ImFontAtlas extra capabilities ----
...
CIMGUI_API int ImFontAtlas_IsBuilt(ImFontAtlas* self) { return self->IsBuilt() ? 1 : 0; }
CIMGUI_API void ImFontAtlas_Set_TexMinWidth(ImFontAtlas* self, int tex_min_width) { self->TexMinWidth = tex_min_width; }
CIMGUI_API int ImFontAtlas_Get_TexMinWidth(ImFontAtlas* self) { return self->TexMinWidth; }

// ---- Standard glyph ranges (exposed out-of-line by imgui.cpp) ----
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesChineseSimplifiedCommon(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesChineseFull(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesChineseFull(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesJapanese(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesJapanese(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesKorean(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesKorean(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesGreek(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesGreek(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesCyrillic(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesCyrillic(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesThai(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesThai(); }
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesVietnamese(ImFontAtlas* self) { return (const unsigned short*)self->GetGlyphRangesVietnamese(); }

// ---- ImVector_ImWchar accessors ----
CIMGUI_API const unsigned short* ImVector_ImWchar_Get_Data(ImVector_ImWchar* self) { return (const unsigned short*)self->Data; }
CIMGUI_API int ImVector_ImWchar_Get_Size(ImVector_ImWchar* self) { return self->Size; }
CIMGUI_API int ImVector_ImWchar_Get_Capacity(ImVector_ImWchar* self) { return self->Capacity; }

// ---- ImFontGlyph accessors ----
CIMGUI_API unsigned int ImFontGlyph_Get_Codepoint(ImFontGlyph* self) { return self->Codepoint; }
CIMGUI_API int ImFontGlyph_Get_Visible(ImFontGlyph* self) { return self->Visible ? 1 : 0; }
CIMGUI_API int ImFontGlyph_Get_Colored(ImFontGlyph* self) { return self->Colored ? 1 : 0; }
CIMGUI_API float ImFontGlyph_Get_AdvanceX(ImFontGlyph* self) { return self->AdvanceX; }
CIMGUI_API float ImFontGlyph_Get_X0(ImFontGlyph* self) { return self->X0; }
CIMGUI_API float ImFontGlyph_Get_Y0(ImFontGlyph* self) { return self->Y0; }
CIMGUI_API float ImFontGlyph_Get_X1(ImFontGlyph* self) { return self->X1; }
CIMGUI_API float ImFontGlyph_Get_Y1(ImFontGlyph* self) { return self->Y1; }
CIMGUI_API float ImFontGlyph_Get_U0(ImFontGlyph* self) { return self->U0; }
CIMGUI_API float ImFontGlyph_Get_V0(ImFontGlyph* self) { return self->V0; }
CIMGUI_API float ImFontGlyph_Get_U1(ImFontGlyph* self) { return self->U1; }
CIMGUI_API float ImFontGlyph_Get_V1(ImFontGlyph* self) { return self->V1; }
CIMGUI_API int ImFontGlyph_Get_PackId(ImFontGlyph* self) { return self->PackId; }
