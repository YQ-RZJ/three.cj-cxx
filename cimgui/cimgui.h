...
CIMGUI_API void ImFontConfig_Set_MergeMode(ImFontConfig* self, int merge_mode);
CIMGUI_API int ImFontConfig_Get_MergeMode(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_PixelSnapH(ImFontConfig* self, int pixel_snap_h);
CIMGUI_API int ImFontConfig_Get_PixelSnapH(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_OversampleH(ImFontConfig* self, int oversample_h);
CIMGUI_API int ImFontConfig_Get_OversampleH(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_OversampleV(ImFontConfig* self, int oversample_v);
CIMGUI_API int ImFontConfig_Get_OversampleV(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_EllipsisChar(ImFontConfig* self, unsigned int ellipsis_char);
CIMGUI_API unsigned int ImFontConfig_Get_EllipsisChar(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_SizePixels(ImFontConfig* self, float size_pixels);
CIMGUI_API float ImFontConfig_Get_SizePixels(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_GlyphRanges(ImFontConfig* self, const unsigned short* glyph_ranges);
CIMGUI_API const unsigned short* ImFontConfig_Get_GlyphRanges(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_GlyphOffset(ImFontConfig* self, ImVec2_c glyph_offset);
CIMGUI_API ImVec2_c ImFontConfig_Get_GlyphOffset(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_GlyphMinAdvanceX(ImFontConfig* self, float glyph_min_advance_x);
CIMGUI_API float ImFontConfig_Get_GlyphMinAdvanceX(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_GlyphMaxAdvanceX(ImFontConfig* self, float glyph_max_advance_x);
CIMGUI_API float ImFontConfig_Get_GlyphMaxAdvanceX(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_GlyphExtraAdvanceX(ImFontConfig* self, float glyph_extra_advance_x);
CIMGUI_API float ImFontConfig_Get_GlyphExtraAdvanceX(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_FontNo(ImFontConfig* self, unsigned int font_no);
CIMGUI_API unsigned int ImFontConfig_Get_FontNo(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_RasterizerMultiply(ImFontConfig* self, float rasterizer_multiply);
CIMGUI_API float ImFontConfig_Get_RasterizerMultiply(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_RasterizerDensity(ImFontConfig* self, float rasterizer_density);
CIMGUI_API float ImFontConfig_Get_RasterizerDensity(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_ExtraSizeScale(ImFontConfig* self, float extra_size_scale);
CIMGUI_API float ImFontConfig_Get_ExtraSizeScale(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_FontData(ImFontConfig* self, void* font_data);
CIMGUI_API void* ImFontConfig_Get_FontData(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_FontDataSize(ImFontConfig* self, int font_data_size);
CIMGUI_API int ImFontConfig_Get_FontDataSize(ImFontConfig* self);
CIMGUI_API void ImFontConfig_Set_FontDataOwnedByAtlas(ImFontConfig* self, int font_data_owned_by_atlas);
CIMGUI_API int ImFontConfig_Get_FontDataOwnedByAtlas(ImFontConfig* self);

// ---- ImGuiIO accessors ----
CIMGUI_API ImFontAtlas* ImGuiIO_Get_Fonts(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_Fonts(ImGuiIO* self, ImFontAtlas* fonts);
CIMGUI_API ImFont* ImGuiIO_Get_FontDefault(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_FontDefault(ImGuiIO* self, ImFont* font_default);
CIMGUI_API ImVec2_c ImGuiIO_Get_DisplaySize(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_DisplaySize(ImGuiIO* self, ImVec2_c display_size);
CIMGUI_API ImVec2_c ImGuiIO_Get_DisplayFramebufferScale(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_DisplayFramebufferScale(ImGuiIO* self, ImVec2_c display_framebuffer_scale);
CIMGUI_API float ImGuiIO_Get_DeltaTime(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_DeltaTime(ImGuiIO* self, float delta_time);
CIMGUI_API int ImGuiIO_Get_ConfigFlags(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_ConfigFlags(ImGuiIO* self, int config_flags);
CIMGUI_API int ImGuiIO_Get_BackendFlags(ImGuiIO* self);
CIMGUI_API void ImGuiIO_Set_BackendFlags(ImGuiIO* self, int backend_flags);

// ---- ImGuiStyle accessors ----
CIMGUI_API float ImGuiStyle_Get_FontScaleMain(ImGuiStyle* self);
CIMGUI_API void ImGuiStyle_Set_FontScaleMain(ImGuiStyle* self, float font_scale_main);
CIMGUI_API float ImGuiStyle_Get_FontSizeBase(ImGuiStyle* self);
CIMGUI_API void ImGuiStyle_Set_FontSizeBase(ImGuiStyle* self, float font_size_base);
...
CIMGUI_API void ImFontAtlas_Set_TexMinWidth(ImFontAtlas* self, int tex_min_width);
CIMGUI_API int ImFontAtlas_Get_TexMinWidth(ImFontAtlas* self);

// ---- Standard glyph ranges (exposed out-of-line by imgui.cpp) ----
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesChineseFull(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesJapanese(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesKorean(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesGreek(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesCyrillic(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesThai(ImFontAtlas* self);
CIMGUI_API const unsigned short* ImFontAtlas_GetGlyphRangesVietnamese(ImFontAtlas* self);

// ---- ImVector_ImWchar accessors ----
CIMGUI_API const unsigned short* ImVector_ImWchar_Get_Data(ImVector_ImWchar* self);
CIMGUI_API int ImVector_ImWchar_Get_Size(ImVector_ImWchar* self);
CIMGUI_API int ImVector_ImWchar_Get_Capacity(ImVector_ImWchar* self);

// ---- ImFontGlyph accessors ----
CIMGUI_API unsigned int ImFontGlyph_Get_Codepoint(ImFontGlyph* self);
CIMGUI_API int ImFontGlyph_Get_Visible(ImFontGlyph* self);
CIMGUI_API int ImFontGlyph_Get_Colored(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_AdvanceX(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_X0(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_Y0(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_X1(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_Y1(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_U0(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_V0(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_U1(ImFontGlyph* self);
CIMGUI_API float ImFontGlyph_Get_V1(ImFontGlyph* self);
CIMGUI_API int ImFontGlyph_Get_PackId(ImFontGlyph* self);
