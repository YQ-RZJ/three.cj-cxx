...
# functions that may not evaluate to constant expressions on every path;
# upstream treats -Winvalid-constexpr as an error there.
if(ANDROID)
	target_compile_options(bx PRIVATE -Wno-invalid-constexpr)
endif()
...
elseif(BX_PLATFORM_OHOS)
	...
	mark_as_advanced(HILOG_LIBRARY)
	if(HILOG_LIBRARY)
		target_link_libraries(bx PUBLIC ${HILOG_LIBRARY})
	endif()
elseif(UNIX)
	# Threads
