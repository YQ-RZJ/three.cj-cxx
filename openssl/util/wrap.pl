...
BEGIN {
    ...
    require '/d/workspace/Projects/three.cj/httpclient4cj/cxx/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/d/workspace/Projects/three.cj/httpclient4cj/cxx/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/d/workspace/Projects/three.cj/httpclient4cj/cxx/openssl/test/default-and-jitter.cnf';
    shift;
